...
Given('Super Calculator Website is opened browser', async function () {
  ...
  When('Select {string} operator from dropdown', async  function (Operator) {
    let operatorCSS:string = "";
    switch(Operator){
      case "Multiply": Operator = "option:nth-child(4)";
      break;
      case "Modulo": Operator = "option:nth-child(3)";
      break;
      case "Divide": Operator = "option:nth-child(2)";
      break;
    }
